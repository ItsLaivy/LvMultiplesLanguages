...
public class NetworkManager extends ObjectExecutor {
    ...
    public @NotNull Channel getChannel() {
        return (Channel) Objects.requireNonNull(multiplesLanguagesBukkit().getVersion().getFieldExec("NetworkManager:channel").invokeInstance(this));
    }

    @Override
    public @NotNull NetworkManagerClass getClassExecutor() {
        return (NetworkManagerClass) multiplesLanguagesBukkit().getVersion().getClassExec("NetworkManager");
    }
