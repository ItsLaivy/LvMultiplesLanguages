...
public class V1_17_R1 extends V1_16_R3 {
    ...
    public void loadClasses() {
        // NBT
        load(V1_17_R1.class, "NBTBase", new NBTBase.NBTBaseClass("net.minecraft.server.v1_17_R1.NBTBase"));

        load(V1_17_R1.class, "NBTBase:NBTTagByte", new NBTTagByte.NBTTagByteClass("net.minecraft.server.v1_17_R1.NBTTagByte"));
        load(V1_17_R1.class, "NBTBase:NBTTagByteArray", new NBTTagByteArray.NBTTagByteArrayClass("net.minecraft.server.v1_17_R1.NBTTagByteArray"));
        load(V1_17_R1.class, "NBTBase:NBTTagCompound", new NBTTagCompound.NBTTagCompoundClass("net.minecraft.server.v1_17_R1.NBTTagCompound"));
        load(V1_17_R1.class, "NBTBase:NBTTagDouble", new NBTTagDouble.NBTTagDoubleClass("net.minecraft.server.v1_17_R1.NBTTagDouble"));
        load(V1_17_R1.class, "NBTBase:NBTTagFloat", new NBTTagFloat.NBTTagFloatClass("net.minecraft.server.v1_17_R1.NBTTagFloat"));
        load(V1_17_R1.class, "NBTBase:NBTTagInt", new NBTTagInt.NBTTagIntClass("net.minecraft.server.v1_17_R1.NBTTagInt"));
        load(V1_17_R1.class, "NBTBase:NBTTagIntArray", new NBTTagIntArray.NBTTagIntArrayClass("net.minecraft.server.v1_17_R1.NBTTagIntArray"));
        load(V1_17_R1.class, "NBTBase:NBTTagList", new NBTTagList.NBTTagListClass("net.minecraft.server.v1_17_R1.NBTTagList"));
        load(V1_17_R1.class, "NBTBase:NBTTagLong", new NBTTagLong.NBTTagLongClass("net.minecraft.server.v1_17_R1.NBTTagLong"));
        load(V1_17_R1.class, "NBTBase:NBTTagShort", new NBTTagShort.NBTTagShortClass("net.minecraft.server.v1_17_R1.NBTTagShort"));
        load(V1_17_R1.class, "NBTBase:NBTTagString", new NBTTagString.NBTTagStringClass("net.minecraft.server.v1_17_R1.NBTTagString"));
        // Items
        load(V1_17_R1.class, "ItemStack", new ItemStack.ItemStackClass("net.minecraft.server.v1_17_R1.ItemStack"));
        ...
        // Packets
        load(V1_17_R1.class, "Packet", new Packet.PacketClass("net.minecraft.server.v1_17_R1.Packet"));
        load(V1_17_R1.class, "PacketPlayOutSetSlot", new PacketPlayOutSetSlot.PacketPlayOutSetSlotClass("net.minecraft.server.v1_17_R1.PacketPlayOutSetSlot"));
        // Player
        load(V1_17_R1.class, "EntityPlayer", new EntityPlayer.EntityPlayerClass("net.minecraft.server.v1_17_R1.EntityPlayer"));
        load(V1_17_R1.class, "CraftPlayer", new CraftPlayer.CraftPlayerClass("org.bukkit.craftbukkit.v1_17_R1.entity.CraftPlayer"));
        load(V1_17_R1.class, "PlayerConnection", new PlayerConnection.PlayerConnectionClass("net.minecraft.server.v1_17_R1.PlayerConnection"));
        load(V1_17_R1.class, "NetworkManager", new NetworkManager.NetworkManagerClass("net.minecraft.server.v1_17_R1.NetworkManager"));
        // Inventory
