...
public class V1_9_R2 extends V1_9_R1 {
    ...
    public V1_9_R2(@NotNull BukkitMultiplesLanguages plugin) {
        super(plugin);
    }
    ...
    public void loadClasses() {
        ...
        load(V1_9_R2.class, "PacketPlayOutWindowItems", new PacketPlayOutWindowItems.PacketPlayOutWindowItemsClass("net.minecraft.server.v1_9_R2.PacketPlayOutWindowItems"));
        // Player
