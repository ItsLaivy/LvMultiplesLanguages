...
public class V1_8_R2 extends V1_8_R1 {
    ...
    public V1_8_R2(@NotNull BukkitMultiplesLanguagesAPI api) {
        super(api);
    }
    ...
    public void loadClasses() {
        ...
        load(V1_8_R2.class, "PacketPlayOutWindowItems", new PacketPlayOutWindowItems.PacketPlayOutWindowItemsClass("net.minecraft.server.v1_8_R2.PacketPlayOutWindowItems"));
        // Player
        ...
        load(V1_8_R2.class, "Slot", new Slot.SlotClass("net.minecraft.server.v1_8_R2.Slot"));
        // Chat
