...
public class V1_18_R1 extends V1_17_R1 {
    ...
    public V1_18_R1(@NotNull BukkitMultiplesLanguages plugin) {
        super(plugin);
    }
    ...
    public boolean onLoad(@NotNull Class<? extends Version> version, @NotNull String key, @NotNull Executor executor) {
        if (version == V1_17_R1.class) {
            if (executor instanceof ClassExecutor) {
                return false;
            } else if (key.equals("PacketPlayOutSetSlot:item") ||
                    key.equals("PacketPlayOutSetSlot:slot") ||
                    key.equals("EntityPlayer:activeContainer") ||
                    key.equals("EntityPlayer:defaultContainer") ||
                    key.equals("Container:windowId") ||
                    key.equals("NetworkManager:channel")
            ) {
                return false;
            }
    ...
    public void loadClasses() {
        ...
        load(V1_18_R1.class, "PacketPlayOutWindowItems", new PacketPlayOutWindowItems.PacketPlayOutWindowItemsClass("net.minecraft.network.protocol.game.PacketPlayOutWindowItems"));
        // Player
        ...
        // Others
        load(V1_18_R1.class, "NonNullList", new NonNullList.NonNullListClass("net.minecraft.core.NonNullList"));
    }
