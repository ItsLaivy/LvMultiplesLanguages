...
public class V1_10_R1 extends V1_9_R2 {
    ...
    public V1_10_R1(@NotNull BukkitMultiplesLanguages plugin) {
        super(plugin);
    }
    ...
    public void loadClasses() {
        ...
        load(V1_10_R1.class, "PacketPlayOutSetSlot", new PacketPlayOutSetSlot.PacketPlayOutSetSlotClass("net.minecraft.server.v1_10_R1.PacketPlayOutSetSlot"));
        load(V1_10_R1.class, "PacketPlayOutWindowItems", new PacketPlayOutWindowItems.PacketPlayOutWindowItemsClass("net.minecraft.server.v1_10_R1.PacketPlayOutWindowItems"));
        // Player
        ...
        // Inventory
        load(V1_10_R1.class, "Container", new Container.ContainerClass("net.minecraft.server.v1_10_R1.Container"));
        load(V1_10_R1.class, "Slot", new Slot.SlotClass("net.minecraft.server.v1_10_R1.Slot"));
        // Chat
