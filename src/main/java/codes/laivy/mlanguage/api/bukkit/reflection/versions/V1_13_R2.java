...
public class V1_13_R2 extends V1_13_R1 {
    ...
    public V1_13_R2(@NotNull BukkitMultiplesLanguages plugin) {
        super(plugin);
    }
    ...
    public void loadClasses() {
        ...
        load(V1_13_R2.class, "CraftMetaItem", new CraftMetaItem.CraftMetaItemClass("org.bukkit.craftbukkit.v1_13_R2.inventory.CraftMetaItem"));
        // Packets
        load(V1_13_R2.class, "Packet", new Packet.PacketClass("net.minecraft.server.v1_13_R2.Packet"));
        load(V1_13_R2.class, "PacketPlayOutSetSlot", new PacketPlayOutSetSlot.PacketPlayOutSetSlotClass("net.minecraft.server.v1_13_R2.PacketPlayOutSetSlot"));
        load(V1_13_R2.class, "PacketPlayOutWindowItems", new PacketPlayOutWindowItems.PacketPlayOutWindowItemsClass("net.minecraft.server.v1_13_R2.PacketPlayOutWindowItems"));
        // Player
        ...
        // Inventory
        load(V1_13_R2.class, "Container", new Container.ContainerClass("net.minecraft.server.v1_13_R2.Container"));
        load(V1_13_R2.class, "Slot", new Slot.SlotClass("net.minecraft.server.v1_13_R2.Slot"));
        // Chat
