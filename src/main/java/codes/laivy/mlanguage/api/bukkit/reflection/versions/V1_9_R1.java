...
public class V1_9_R1 extends V1_8_R3 {
    ...
    public V1_9_R1(@NotNull BukkitMultiplesLanguagesAPI api) {
        super(api);
    }
    ...
    public void loadClasses() {
        ...
        load(V1_9_R1.class, "PacketPlayOutSetSlot", new PacketPlayOutSetSlot.PacketPlayOutSetSlotClass("net.minecraft.server.v1_9_R1.PacketPlayOutSetSlot"));
        load(V1_9_R1.class, "PacketPlayOutWindowItems", new PacketPlayOutWindowItems.PacketPlayOutWindowItemsClass("net.minecraft.server.v1_9_R1.PacketPlayOutWindowItems"));
        // Player
        ...
        // Inventory
        load(V1_9_R1.class, "Container", new Container.ContainerClass("net.minecraft.server.v1_9_R1.Container"));
        load(V1_9_R1.class, "Slot", new Slot.SlotClass("net.minecraft.server.v1_9_R1.Slot"));
        // Chat
