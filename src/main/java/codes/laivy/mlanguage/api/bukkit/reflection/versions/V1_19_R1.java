...
public class V1_19_R1 extends V1_18_R2 {
    ...
    public V1_19_R1(@NotNull BukkitMultiplesLanguagesAPI api) {
        super(api);
    }
    ...
    public void loadClasses() {
        ...
        load(V1_19_R1.class, "PacketPlayOutWindowItems", new PacketPlayOutWindowItems.PacketPlayOutWindowItemsClass("net.minecraft.network.protocol.game.PacketPlayOutWindowItems"));
        // Player
        ...
        // Others
        load(V1_19_R1.class, "NonNullList", new NonNullList.NonNullListClass("net.minecraft.core.NonNullList"));
    }
