...
public class V1_16_R1 extends V1_15_R1 {
    ...
    public V1_16_R1(@NotNull BukkitMultiplesLanguages plugin) {
        super(plugin);
    }
    ...
    public void loadClasses() {
        ...
        load(V1_16_R1.class, "CraftMetaItem", new CraftMetaItem.CraftMetaItemClass("org.bukkit.craftbukkit.v1_16_R1.inventory.CraftMetaItem"));
        // Packets
        load(V1_16_R1.class, "Packet", new Packet.PacketClass("net.minecraft.server.v1_16_R1.Packet"));
        load(V1_16_R1.class, "PacketPlayOutSetSlot", new PacketPlayOutSetSlot.PacketPlayOutSetSlotClass("net.minecraft.server.v1_16_R1.PacketPlayOutSetSlot"));
        load(V1_16_R1.class, "PacketPlayOutWindowItems", new PacketPlayOutWindowItems.PacketPlayOutWindowItemsClass("net.minecraft.server.v1_16_R1.PacketPlayOutWindowItems"));
        // Player
