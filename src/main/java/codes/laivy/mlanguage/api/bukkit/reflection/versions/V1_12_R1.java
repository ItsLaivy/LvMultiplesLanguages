...
public class V1_12_R1 extends V1_11_R1 {
    ...
    public V1_12_R1(@NotNull BukkitMultiplesLanguagesAPI api) {
        super(api);
    }
    ...
    public void loadClasses() {
        ...
        load(V1_12_R1.class, "PacketPlayOutSetSlot", new PacketPlayOutSetSlot.PacketPlayOutSetSlotClass("net.minecraft.server.v1_12_R1.PacketPlayOutSetSlot"));
        load(V1_12_R1.class, "PacketPlayOutWindowItems", new PacketPlayOutWindowItems.PacketPlayOutWindowItemsClass("net.minecraft.server.v1_12_R1.PacketPlayOutWindowItems"));
        // Player
