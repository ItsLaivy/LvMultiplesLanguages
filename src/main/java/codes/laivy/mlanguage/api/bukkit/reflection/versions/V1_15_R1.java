...
public class V1_15_R1 extends V1_14_R1 {
    ...
    public V1_15_R1(@NotNull BukkitMultiplesLanguagesAPI api) {
        super(api);
    }
    ...
    public void loadClasses() {
        ...
        load(V1_15_R1.class, "PacketPlayOutWindowItems", new PacketPlayOutWindowItems.PacketPlayOutWindowItemsClass("net.minecraft.server.v1_15_R1.PacketPlayOutWindowItems"));
        // Player
