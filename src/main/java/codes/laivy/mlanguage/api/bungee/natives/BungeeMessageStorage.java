...
public class BungeeMessageStorage implements IBungeeMessageStorage {
    ...
    protected BungeeMessageStorage(@NotNull Plugin plugin, @NotNull String name, @NotNull Locale defaultLocale, @NotNull Map<@NotNull String, Map<Locale, @NotNull BaseComponent[][]>> components, @NotNull Map<Locale, Set<String>> legaciesTexts, @NotNull Map<Locale, Set<String>> arrayTexts) {
    ...
    public static @NotNull BungeeMessageStorage deserialize(@NotNull SerializedData serializedData) {
        if (serializedData.getVersion() == 0) {
            ...
            return new BungeeMessageStorage(plugin, name, defaultLocale, components, legaciesTexts, arrayTexts);
        } else {
